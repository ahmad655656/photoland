  ...
  return <footer className='pt-16 bg-primary'>
    <div className='container mx-auto'>
      <div className='text-center'>
        ...
        <p className='text-white/70'>Be te first to get the latest news about trends, promotions and much morel</p>
      </div>
      {/* form */}
    ...
    <div className='py-10 border-t border-t-white/10'>
      <div className='container mx-auto'>
        <div className='text-center text-sm text-white/60'>Copyright &copy; Photoland 2025. All rights reserved </div>
      </div>
    </div>
  </footer>;
};
